...
const EditCategory = () => {
  ...
  const onSubmit = (data) =>
    axios
      .post("http://127.0.0.1:8000/api/category/update/" + id, data)
      .then(function (response) {
    ...
    <div className="row">
      <div className="col-md-6">
        <div className="form-group">
          ...
          <input type="text" className="form-control" name="name" ref={register({ required: true, maxLength: 20 })}/>
        ...
        <div className="form-group">
          ...
          <input type="text" className="form-control" name="description" ref={register({ required: true, minLength: 10 })}/>
          {errors.description && <span style={{ color: "red" }}>Không được trống, phải lớn hơn 10 kí tự</span>}
        </div>
      </div>
