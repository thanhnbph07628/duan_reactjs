...
const AddCateNews = () => {
  ...
  const onSubmit = data =>
  axios
      .post("http://127.0.0.1:8000/api/catenews/add/", data)
    ...
    <div className="row">
      <div className="col-md-6">
        <div className="form-group">
          ...
          {errors.name && <span style={{ color: "red" }}>Không được để trống, không chứa ký tự đặc biệt, không vượt quá 20 ký tự</span>}
        </div>
        <div className="form-group">
        ...
        <div className="form-group">
          ...
          {errors.description && <span style={{ color: "red" }}>Không được để trống, không chứa ký tự đặc biệt, phải lớn hơn 10 kí tự</span>}
        </div>
      </div>
