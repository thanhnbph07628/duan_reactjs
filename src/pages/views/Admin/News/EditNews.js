...
const EditNews = () => {
  ...
  const setList = () => {
    axios
      .get("http://127.0.0.1:8000/api/news/edit/" + id)
  ...
  const onSubmit = (data) =>
    axios
      .post("http://127.0.0.1:8000/api/news/update/" + id, data)
      .then(function (response) {
      ...
      <div className="row">
        <div className="col-md-6">
          ...
          <div className="form-group">
            ...
            <input type="text" className="form-control" ref={register({ required: true, maxLength: 100, pattern:/^[A-Za-z0-9]/ })} name="name"/>
