...
const ListNewsCate = () => {
    ...
    const setList = () => {
        axios
            .get("http://127.0.0.1:8000/api/client/list_news_cate/" + id)
            .then(function (response) {
                                        ...
                                        <div className="row" key={index} style={{marginBottom:"30px"}}>
                                            <div className="col-lg-6">
                                                <div className="li-blog-banner">
                                                    <a href="blog-details-left-sidebar.html"><img className="img-full" src={news.images} alt="" /></a>
                                                </div>
                                            </div>
                                            <div className="col-lg-6">
                                                <div className="li-blog-content">
                                                    <div className="li-blog-details">
                                                        <h3 className="li-blog-heading pt-xs-25 pt-sm-25"><a href="blog-details-left-sidebar.html">blog image post</a></h3>
